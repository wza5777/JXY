...
<%@ page language="java" import="entity.Operator"%>
<%
...
<html>
 ...
 <meta  http-equiv ="content-type"  content ="text/html; charset=utf-8" >
	...
	<script type="text/javascript" src="JXY/js/app.js"></script>
	 <script type="text/javascript" src="JXY/jsp/home/home.js"></script>
	...
	initComponent : function() {
		Ext.apply(this, {
			...
			height : 23,
			items : [
					"当前用户：<%=o.getName() %>[<a href='javascript:logout();' id='href_back'>退出系统</a>]",
					'->',
	...
	function logout(){
		$.ajax( {
					type : 'POST',
				url : '<%=basePath%>admin_logout.do?op=1',
					timeout: 10000,    
					async:false,
					dataType : 'json',
